...
<body>
<header class="header">
    <a href="/"><img class="logo" src="/src/polytech_logo_main_RGB.png" alt="logo"></a>
...
<div class="main">
    <div class="gridContainer">
        <div class="gridCalculator">
            ...
            <div class="buttonCalc buttonSin" id="sin">sin</div>
            <div class="buttonCalc buttonCos" id="cos">cos</div>
            <div class="buttonCalc buttonTg" id="tg">tg</div>
            <div class="buttonCalc buttonCtg" id="ctg">ctg</div>
...
<footer class="footer">Политехнический университет</footer>
</body>
</html>
